...
BroFoPy converts the *.bron/.hdf5* files into a custom BronFormat class and provides a workflow
to convert the data into a [Pandas](https://github.com/pandas-dev/pandas) `DataFrame` or a
